      ...
      <div style={{ padding: "16px" }}>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "flex-start", marginBottom: 20 }}>
          ...
          <div style={{
            ...
            background: dealer.avatarColor, overflow: "hidden",
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 12, color: "#888780", marginTop: 6 }}>完了件数 {dealer.completedJobs}件</p>
            <p style={{ fontSize: 12, color: "#888780", marginTop: 2 }}>経験{dealer.experienceYears}年</p>
